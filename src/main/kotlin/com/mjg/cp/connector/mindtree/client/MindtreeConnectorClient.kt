...
import com.mjg.cp.connector.mindtree.extension.tomindtreeErrors
...
import com.mjg.cs.common.toUsDollar
...
class MindtreeConnectorClient(
    ...
    fun createCustomer(customerRequest: com.mjg.cp.connector.mindtree.request.CustomerRequest): CustomerResponse {
